...
exports.SpecializedAgents = void 0;
class SpecializedAgents {
    static createScriptAnalyst() {
        return {
            id: 'script_analyst',
            name: 'Script Analyst',
...
exports.SpecializedAgents = SpecializedAgents;
