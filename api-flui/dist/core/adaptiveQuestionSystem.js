...
exports.AdaptiveQuestionSystem = void 0;
const uuid_1 = require("uuid");
class AdaptiveQuestionSystem {
    async generateClarifyingQuestions(intent) {
        const questions = [];
    ...
    async processUserAnswers(intent, answers) {
    ...
    async suggestTechnologies(domain) {
        switch (domain) {
            case 'frontend':
    ...
    async validateAnswers(questions, answers) {
        const errors = [];
...
exports.AdaptiveQuestionSystem = AdaptiveQuestionSystem;
//# sourceMappingURL=adaptiveQuestionSystem.js.map